...
func TestCreateDevice(t *testing.T) {
	...
	id, err := CreateDevice(db, Device{Name: "My PC", MACAddress: "AA:BB:CC:DD:EE:FF", IPAddress: "192.168.4.100", Port: 9, StatusPort: 3389})
...
func TestListDevices(t *testing.T) {
	db, _ := InitDB(":memory:"); defer db.Close()
	CreateDevice(db, Device{Name: "PC1", MACAddress: "AA:BB:CC:DD:EE:01", IPAddress: "192.168.4.1", Port: 9, StatusPort: 3389})
	CreateDevice(db, Device{Name: "PC2", MACAddress: "AA:BB:CC:DD:EE:02", IPAddress: "192.168.4.2", Port: 9, StatusPort: 3389})
